...
public class AutomobilUnosController {
	...
	public void unesi() {
		...
		} else if (!Funkcije.isNumber(snagaTextField.getText())) {
		...
		Automobil auto = new Automobil(null, naslov, opis, snaga, cijena, stanje);

		try {
			BazaPodataka.pohraniAutomobil(auto);
